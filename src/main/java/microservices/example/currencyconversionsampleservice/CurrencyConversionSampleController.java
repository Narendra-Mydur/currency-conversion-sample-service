package microservices.example.currencyconversionsampleservice;
...
public class CurrencyConversionSampleController {
                    ...
                    @PathVariable BigDecimal quantity)
    {
        ...
        ResponseEntity<CurrencyConversionSampleBean>
                ...
                "http://localhost:9096/currency-exchange-sample/fromCurrency/{fromCurrency}/toCurrency/{toCurrency}",
